...
public class SingleCloudSshAgentFactory<K extends CloudKeyInfo> implements CloudSshAgentFactory<K> {
    ...
    private SingleCloudSshAgentFactory(CloudSshAgentProvider<K> sshAgentProvider) {
    ...
    public static <T extends CloudKeyInfo> CloudSshAgentFactory<T> of(CloudSshAgentProvider<T> agentProvider) {
        return new SingleCloudSshAgentFactory<>(agentProvider);
    }
