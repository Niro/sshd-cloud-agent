...
public class GoogleIntegrationTest extends AbstractIntegrationTest {
    ...
    protected SshAgentFactory createCloudFactory() throws Exception {
        InputStream creds = new ByteArrayInputStream(readEnv("GOOGLE_AUTH_JSON").getBytes());
        ...
        return CloudSshAgentFactory.of(new GoogleCloudSshAgentProvider(client, KEY_INFOS));
    }
